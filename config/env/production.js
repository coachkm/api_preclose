  ...
  datastores: {
    ...
    ***************************************************************************/
    default: {
      ...
      url: 'mongodb://prec_user:PrRoECcLSu722foSeEL@74.208.41.106:27017/db_preclose',  
      // adapter: 'sails-mysql',
  ...
  ***************************************************************************/
  sockets: {
    ...
    ***************************************************************************/
    ...
    // ],
 onlyAllowOrigins: [
    'https://admin.smartcloze.com',
    'https://endpoint.smartcloze.com',
    'https://app.smartcloze.com',
    'http://127.0.0.1:8804',
    'http://localhost:8804'
  ],
